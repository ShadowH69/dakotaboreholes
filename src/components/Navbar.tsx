      ...
      <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
        <a href="/#home" className="flex items-center gap-2 sm:gap-3 group">
          ...
          <div className="hidden sm:block leading-tight">
            <span className="font-heading text-sm sm:text-base font-bold text-primary-foreground tracking-wide block">
              {config.text.companyName}
            </span>
            <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.15em] text-primary-foreground/50 font-medium">
              {config.text.companyTagline}
            </span>
          </div>
        </a>
        ...
        <div className="bg-[hsl(var(--section-dark))]/98 backdrop-blur-xl border-t border-primary-foreground/5 px-4 pb-6 pt-2">
          {links.map((link) => (
            <a
              ...
              className="flex items-center justify-between py-3 border-b border-primary-foreground/5 font-body text-sm font-medium text-primary-foreground/70 hover:text-secondary transition-colors"
            >
              {link.label}
          ...
          <a
            href="tel:0712857397"
            className="flex items-center justify-center gap-2 mt-4 bg-secondary px-6 py-3 rounded-xl font-heading text-sm uppercase tracking-wider text-secondary-foreground"
          >
